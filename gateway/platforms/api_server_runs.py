...
async def _handle_run_events(
    ...
    *,
    ...
    try:
        ...
        # A client disconnect is only a transport change. Keep the queue while
        # the executor-backed run is active so a later client can reconnect.
        # The periodic orphan sweep owns transport-TTL cleanup.
